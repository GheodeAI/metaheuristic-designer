...
def run_algorithm(alg_name, memetic, save_state, show_plots, objective, dim, reporter, random_state):
    ...
    search_strategy_map = {
        "hillclimb": HillClimb(
            initializer=UniformInitializer(objfunc.vecsize, objfunc.lower_bound, objfunc.upper_bound, population_size=1, random_state=random_state),
        ...
        "es": ES(
            initializer=UniformInitializer(objfunc.vecsize, objfunc.lower_bound, objfunc.upper_bound, population_size=100, random_state=random_state),
        ...
        "crossentropy": CrossEntropyMethod(
            initializer=UniformInitializer(objfunc.vecsize, objfunc.lower_bound, objfunc.upper_bound, population_size=1000, random_state=random_state),
            random_state=random_state,
        ),
        ...
        "randomsearch": RandomSearch(UniformInitializer(objfunc.vecsize, objfunc.lower_bound, objfunc.upper_bound, population_size=100, random_state=random_state)),
        "nosearch": NoSearch(UniformInitializer(objfunc.vecsize, objfunc.lower_bound, objfunc.upper_bound, population_size=100, random_state=random_state)),
    }
    ...
    if memetic:
        local_search = LocalSearch(
            initializer=UniformInitializer(objfunc.vecsize, objfunc.lower_bound, objfunc.upper_bound, population_size=search_strategy.initializer.pop_size),
