...
from metaheuristic_designer.benchmarks import BinKnapsack, ThreeSAT, MaxClique
...
def run_algorithm(alg_name, problem, ngen, seed):
    ...
    if problem == "Knapsack":
        ...
        weights = [7,0,30,22,80,94,11,81,70,64,59,18,0,36,3,8,15,42,9,0,42,47,52,32,26,
...
def main():
    ...
    parser.add_argument("-p", "--problem", default="Knapsack",
