...
test_population1 = [Individual(objfunc, vec, individual_id=idx) for idx, vec in enumerate(test_population_arr1)]
...
test_population2 = [Individual(objfunc, vec, individual_id=idx) for idx, vec in enumerate(test_population_arr2)]
...
test_population3 = [Individual(objfunc, vec, individual_id=idx) for idx, vec in enumerate(test_population_arr3)]
...
@pytest.mark.parametrize(
    "population, amount, id_list",
    [
        (test_population1, 2, [3, 2]),
        (test_population1, 5, [3, 2, 4, 0, 5]),
