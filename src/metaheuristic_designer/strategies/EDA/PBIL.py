    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            initializer,
            operator=create_operator("full_resampling", distribution="bernoulli", p=p, rng=rng),
    ...
    def estimate_parameters(self, population):
        ...
        if old_p is not None:
            ...
            new_p += self.rng.normal(0, self.params.noise, size=np.asarray(old_p).shape)
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            initializer,
            operator=create_operator("full_resampling", distribution="gaussian", loc=loc, scale=np.asarray(scale), rng=rng),
            parent_sel=parent_sel,
            survivor_sel=survivor_sel,
            offspring_size=offspring_size,
            name=name,
