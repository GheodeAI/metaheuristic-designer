    ...
    def perturb(self, indiv_list, objfunc, **kwargs):
        ...
        for indiv in indiv_list:
            ...
            for _ in range(self.iterations):
                parents, _ = self.local_search.select_parents(
                    population, progress, history
                )

                offspring = self.local_search.perturb(
                    parents, objfunc, progress, history
                )

                population = self.local_search.select_individuals(
                    population, offspring, progress, history
                )
