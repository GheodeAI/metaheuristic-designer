...
class CompositeInitializer(Initializer):
    def __init__(
        ...
        super().__init__(dimension, population_size, encoding=encoding, random_state=random_state)
    ...
    def generate_random(self) -> VectorLike:
        ...
        idx = self.random_state.choice(len(self.initializers), p=self.weights)
    ...
    def generate_population(self, objfunc, n_individuals=None):
        ...
        choice_idx = self.random_state.choice(n_initializers, n_individuals, p=self.weights)
